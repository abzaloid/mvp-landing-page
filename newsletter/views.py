...
def home(request):
	...
	top_text = u'Статистика Казахстана с креативными идеями и визуалицациями. Примеры: тепловая карта Казахстана с данными о криминальности и дорожно-транспортных проишевствий(ДТП) городов, правда о букмекерских конторах основанная на реальных данных и многое другое. Следите за нами.'
